...
| Pasta | Conteúdo |
|---|---|
| `raw/` | composto por 2 databases que foram editadas via merge |
...
| MONTHS_BALANCE      | Record month on          | The month of the extracted data is the starting point, backwards, 0 is the current month, -1 is the previous month, and so 
